      ...
      return (
         <div className="messages-wrapper">
            ...
            <Modal isOpen={this.state.newMessageModal} toggle={() => this.toggleWriteNewMessageModal()} className={this.props.className}>
               ...
               <ModalFooter>
                  <Button variant="contained" color="primary" className="text-white" onClick={() => this.addNewMessage()}>Save</Button>{' '}
                  <Button variant="contained" className="btn-danger text-white" onClick={() => this.toggleWriteNewMessageModal()}>Cancel</Button>
               </ModalFooter>
            </Modal>
