      ...
      <div className="progress-wrapper">
        ...
        <div className="row">
          ...
          >
            ...
            />
            <CircularProgress
              className="progress-danger mr-30 mb-10"
              size={70}
              mode="determinate"
              value={35}
              min={0}
            ...
            />
            <CircularProgress
              className="progress-success mr-30 mb-10"
              size={60}
              mode="determinate"
              value={75}
            />
            <CircularProgress
              className="progress-warning mr-30 mb-10"
              size={70}
              mode="determinate"
              value={40}
              min={0}
        ...
        <div className="sub-title">
          <h4>
            <IntlMessages id="widgets.linearProgressLineBar" />{" "}
          </h4>
        </div>
        <div className="row">
          <RctCollapsibleCard
