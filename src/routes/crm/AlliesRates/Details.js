...
import { FeatureDisplayData } from "./DisplayData";
      ...
      <div className="col-md-12">
              <div className="row justify-content-end">
                <div className="col-md-2">
                  <button type="button"  onClick={()=>history.push(`/cw/dashboard/features/${featureId}/edit`)} className="btn btn-primary text-center text-white">
