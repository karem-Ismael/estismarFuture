                  ...
                  <div className="d-sm-flex justify-content-between w-100">
                    ...
                    <Panel className="mx-10 mb-20 mb-sm-0" header="Category">
                      <div className="app-selectbox-sm">
                        <MenuSelect attribute="categories" limit={5} />
                      </div>
                    </Panel>
                    <Panel className="mx-10 mb-20 mb-sm-0" header="Brand">
                      <div className="app-selectbox-sm">
                        <MenuSelect attribute="brand" limit={5} />
                      </div>
                    </Panel>
                    <Panel className="mx-10 mb-20 mb-sm-0" header="Type">
                      <div className="app-selectbox-sm">
                        <MenuSelect attribute="type" limit={5} />
                      </div>
                    </Panel>
                  </div>
                </AccordionDetails>
