							...
							{employeePayroll && employeePayroll.map((employee, key) => (
								<tr key={key}>
									...
									<td className="table-action">
										{employee.status === 0 && <a href="#" onClick={(e) => this.onCheckBoxClick(e, employee)}><i className="ti-check"></i></a>}
										<a href="#" onClick={(e) => this.deleteEmployePayroll(e, employee)}><i className="ti-close"></i></a>
									</td>
								</tr>
							))}
						</tbody>
