      ...
      <Card className="rct-block">
        <CardBody className="d-flex">
          ...
          <div>
            ...
            <span className="fs-12 mb-20 d-block text-muted">
              <IntlMessages id="widgets.AcceptorrRejectWithin" />
            </span>
            <h1 className="border py-5 px-15 d-inline-block mr-20">
              {" "}
              <CountDown time={500000} />{" "}
            </h1>
